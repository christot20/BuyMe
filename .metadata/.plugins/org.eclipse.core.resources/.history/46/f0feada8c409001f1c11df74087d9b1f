...
<body>
    ...
    <table>
        ...
        <% try {
            ...
            String str = "SELECT name, computer_type, ram, storage, cpu, list_date, expiration_date, current_bid  FROM computers where item_id in (select item_id from bid where user_id = ?)";
