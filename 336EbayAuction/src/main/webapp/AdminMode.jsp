...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <button onclick="window.location.href='Reports.jsp'">View Reports</button>
            <button onclick="window.location.href='AdminManageUsers.jsp'">Manage Users</button>
            <button onclick="window.location.href='BrowseQuestions.jsp'">Answer User Questions</button>
